    ...
    <div class="main">
        <div class="left-box">
            <div class="left-wrap">
                ...
                <?php
                $sql_result = "SELECT * FROM `results_table` ORDER BY 1st_total + 2nd_total + 3rd_total + 4th_total DESC , best_rank ASC , 1st_kill + 2nd_kill + 3rd_kill + 4th_kill  DESC LIMIT 0,3";
                ...
                <?php
                $sql_result = "SELECT * FROM `results_table` ORDER BY 1st_total + 2nd_total + 3rd_total + 4th_total DESC , best_rank ASC , 1st_kill + 2nd_kill + 3rd_kill + 4th_kill  DESC LIMIT 3,3";
        ...
        <div class="right-box">
            <div class="right-wrap">
                ...
                <?php
                $sql_result = "SELECT * FROM `results_table` ORDER BY 1st_total + 2nd_total + 3rd_total + 4th_total DESC , best_rank ASC , 1st_kill + 2nd_kill + 3rd_kill + 4th_kill  DESC LIMIT 6,8";
                $result_array = $pdo_result->query($sql_result);
