...
<head>
    ...
    <link rel="stylesheet" href="../css/up.css?ver=1.006">
    <link rel="stylesheet" href="../css/header.css?ver=1.012">
</head>

<body>
    <div class="title"><h2>3試合目ー1チームごと入力</h2></div>
    <header>
        <?php
        $page = 2;
    ...
    <main>
        <form action="up3-2.php" method="POST" name="test">
            <?php
            $teamname = 'teamname_';
            $kill = 'kill_';
            $j = 1;
