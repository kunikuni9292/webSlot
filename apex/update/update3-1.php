...
for ($num = 1; $num <= 14; $num++) {
    ...
    $stmt->bindValue(':3rd_rank', $j);
    $stmt->bindValue(':3rd_kill', $team_kill);
    $stmt->bindValue(':3rd_total', $team_total);
