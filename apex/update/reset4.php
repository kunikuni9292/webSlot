...
for ($num = 1; $num <= 14; $num++) {
    ...
    $stmt = $pdo2->prepare('UPDATE results_table SET  4th_rank = :4th_rank , 4th_kill = :4th_kill , 4th_total = :4th_total WHERE id = :id');

    $reset = 0;

    $stmt->bindValue(':id', $j);
    $stmt->bindValue(':4th_rank', $reset);
    $stmt->bindValue(':4th_kill', $reset);
    $stmt->bindValue(':4th_total', $reset);
        ...
        <main>
            ...
            <div class="main-flex">
                <div class="left-box">
                    ...
                    <?php
                    $sql_result = "SELECT * FROM `results_table` ORDER BY 4th_rank ASC LIMIT 0,5";
                ...
                <div class="right-box">
                    ...
                    <hr class="index-bottom">
                    <?php
                    $sql_result = "SELECT * FROM `results_table` ORDER BY 4th_rank ASC LIMIT 5,5";
                    $result_array = $pdo_result->query($sql_result);
                ...
                <div class="right-box">
                    ...
                    <hr class="index-bottom">
                    <?php
                    $sql_result = "SELECT * FROM `results_table` ORDER BY 4th_rank ASC LIMIT 10,5";
                    $result_array = $pdo_result->query($sql_result);
