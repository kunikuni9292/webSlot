...
for ($num = 1; $num <= 14; $num++) {
    ...
    $stmt->bindValue(':4th_rank', $j);
    $stmt->bindValue(':4th_kill', $team_kill);
    $stmt->bindValue(':4th_total', $team_total);
