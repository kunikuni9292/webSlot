...
for ($num = 1; $num <= 14; $num++) {
    ...
    $stmt = $pdo2->prepare('UPDATE results_table SET  5th_rank = :5th_rank , 5th_kill = :5th_kill  WHERE id = :id');

    $reset = 0;

    $stmt->bindValue(':id', $j);
    $stmt->bindValue(':5th_rank', $reset);
    $stmt->bindValue(':5th_kill', $reset);
        ...
        <main>
            ...
            <div class="main-flex">
                <div class="left-box">
                    ...
                    <?php
                    $sql_result = "SELECT * FROM `results_table` ORDER BY 5th_rank ASC LIMIT 0,5";
                ...
                <div class="right-box">
                    ...
                    <hr class="index-bottom">
                    <?php
                    $sql_result = "SELECT * FROM `results_table` ORDER BY 5th_rank ASC LIMIT 5,5";
                    $result_array = $pdo_result->query($sql_result);
                ...
                <div class="right-box">
                    ...
                    <hr class="index-bottom">
                    <?php
                    $sql_result = "SELECT * FROM `results_table` ORDER BY 5th_rank ASC LIMIT 10,4";
                    $result_array = $pdo_result->query($sql_result);
