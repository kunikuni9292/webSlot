...
for ($num = 1; $num <= 14; $num++) {
    ...
    $stmt = $pdo2->prepare('UPDATE results_table SET 1st_rank = :1st_rank , 1st_kill = :1st_kill , 1st_total = :1st_total ,best_rank = :best_rank  WHERE id = :id');
    ...
    $stmt->bindValue(':1st_total', $team_total);
    $stmt->bindValue(':best_rank', $j);
